  ...
  <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8 px-4">
    <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6 text-white">
        ...
        <p className="text-blue-100 mt-2">Düşüncelerinizi paylaşın ve diğer kullanıcılarla etkileşime geçin</p>
      </div>
      ...
      <div className="p-6">
        ...
        >
          ...
          <Form.Item
            label={<span className="text-gray-700 font-medium">İçerik</span>}
            name="content"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Form.Item 
              label={<span className="text-gray-700 font-medium">Görsel URL</span>} 
              name="image"
              className="mb-0"
            >
              <Input 
